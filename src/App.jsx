...
// poc-survey-tooling.app/__import__ [25] 
...
// poc-survey-tooling.app/surveyData [31] 
var surveyData = {
...
// poc-survey-tooling.app/App [67] 
function App(){
  return (
    <>
      <app_client.AppClient port={58668}></app_client.AppClient>
      <SurveyReactUi.Survey model={new SurveyCore.Model(surveyData)}></SurveyReactUi.Survey>
    </>);
}

// poc-survey-tooling.app/__main__ [80] 
